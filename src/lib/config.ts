...
export const SOCIALS = [
  ...
  { name: "Bilibili", href: "https://space.bilibili.com/9655855", linkTitle: `${SITE.title} on Bilibili`, icon: "bilibili", active: true },
  { name: "Douyin", href: "https://v.douyin.com/HWMgjLaTtFk", linkTitle: `${SITE.title} on Douyin`, icon: "douyin", active: true },
  { name: "Mail", href: "mailto:1722288011@qq.com", linkTitle: `Send an email to ${SITE.title}`, icon: "mail", active: false },
] as const;

export const SHARE_LINKS = [
  { name: "WeChat", href: "", linkTitle: "分享到微信", icon: "wechat" },
  { name: "QQ", href: "https://connect.qq.com/widget/shareqq/index.html?url=", linkTitle: "分享到QQ", icon: "qq" },
