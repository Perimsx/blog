...
tags:
  ...
  - Web安全与加固
  - DDoS
description: 主流网络攻击手法原理深度解析，涵盖DDoS分布式拒绝服务、MITM中间人劫持、SQL注入、LXSS跨站脚本、CSRF跨站请求伪造及命令注入等攻击的分类、技术原理与系统性防御方案
coverImage: ./covers/sec003-cover.webp
url: sec003
---
> 阅读提示
> 适合对象：想建立攻击面认知的安全初学者、开发者与测试人员。
> 阅读前提：了解 HTTP、浏览器与基础网络通信概念。
> 核心收获：快速区分常见攻击原理、触发条件与对应防护思路。
