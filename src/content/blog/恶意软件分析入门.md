...
tags:
  - 逆向分析与安全研究
description: 从零构建恶意软件分析能力，掌握静态分析与动态行为监控技术栈，详解工具链、YARA规则编写与Cuckoo沙箱实战方法
coverImage: ./covers/sec014-cover.webp
url: sec014
---
> 阅读提示
> 适合对象：准备进入恶意代码分析、沙箱分析和 YARA 检测方向的初学者。
> 阅读前提：了解 PE 文件、进程、网络连接等基础系统概念。
> 核心收获：形成静态分析、动态分析与规则提取的入门框架。
