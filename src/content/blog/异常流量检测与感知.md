...
tags:
  - 威胁情报与感知
  - 日志与流量分析
description: 构建完整态势感知能力体系，掌握流量基线建立与动态调整方法，详解Zeek部署配置与机器学习异常检测实战技巧
coverImage: ./covers/sec015-cover.webp
url: sec015
---
> 阅读提示
> 适合对象：做流量监测、态势感知和异常检测的安全运营同学。
> 阅读前提：了解日志、流量、规则检测和基础统计概念。
> 核心收获：把基线建立、规则分析和机器学习检测放到同一套思路里。
