...
tags:
  - 密码学
description: 系统掌握现代密码学核心原理，深入理解对称与非对称加密体系，从AES/RSA到PKI完整知识图谱，配合OpenSSL命令实战演示
coverImage: ./covers/sec004-cover.webp
url: sec004
---
> 阅读提示
> 适合对象：想补齐加密、签名、证书体系基础的开发者与安全从业者。
> 阅读前提：了解二进制、编码和基础命令行操作。
> 核心收获：把对称加密、非对称加密、哈希和 PKI 串成完整知识链。
