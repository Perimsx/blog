---
pubDatetime: '2025-12-26T00:00:00.000Z'
title: IDS/IPS部署实战
featured: false
draft: false
tags:
...
---
> 阅读提示
> 适合对象：计划部署 Snort、Suricata 或做流量检测规则编写的读者。
> 阅读前提：了解 TCP/IP、抓包和基本 Linux 服务部署。
> 核心收获：理解 IDS/IPS 部署模式、规则设计与误报调优方法。
> 说明：规则语法与性能参数可能因版本不同而变化。
