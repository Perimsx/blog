---
pubDatetime: '2026-01-13T00:00:00.000Z'
title: 提权技术与利用详解
featured: false
draft: false
tags:
  - Linux安全与加固
  - 渗透测试(预攻/后渗透)
description: 深入剖析Linux提权攻击路径，详解SUID/SGID利用、内核漏洞提权、Cron任务劫持与LinPEAS自动化枚举实战技巧
coverImage: ./covers/sec025-cover.webp
url: sec025
---
> 阅读提示
> 适合对象：在做 Linux 渗透、提权排查和本地利用学习的读者。
> 阅读前提：会使用常见 Linux 命令并理解权限模型。
> 核心收获：识别高频提权路径，并把自动化枚举与手工验证结合起来。
> 说明：内核版本、发行版差异和补丁状态会直接影响利用结果。
