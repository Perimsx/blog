---
pubDatetime: '2026-01-14T00:00:00.000Z'
title: Linux后渗透与持久化
featured: false
draft: false
tags:
...
---
> 阅读提示
> 适合对象：在学习 Linux 后渗透、隧道与持久化机制的读者。
> 阅读前提：具备基础 Shell、SSH 和 Linux 权限管理经验。
> 核心收获：构建后渗透阶段的控制、隐蔽和维持访问思路。
> 说明：示例仅适用于授权实验环境，生产系统请优先做检测与加固。
