...
tags:
  - 算法开发与系统设计
description: BFS/DFS遍历、Dijkstra/Floyd最短路径、Prim/Kruskal最小生成树、拓扑排序完整解析与代码实现
coverImage: ./covers/algo003-cover.webp
url: algo003
---
> 阅读提示
> 适合对象：想系统梳理 BFS、DFS、最短路和最小生成树的算法学习者。
> 阅读前提：理解队列、栈、优先队列和邻接表。
> 核心收获：明确图论高频算法的适用边界与题型切换方式。
