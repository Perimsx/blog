...
tags:
  - 漏洞与风险管理
description: 漏洞管理全生命周期与CVSS评分体系深度解读，Nessus与OpenVAS扫描器部署配置及自动化集成实战指南
coverImage: ./covers/sec020-cover.webp
url: sec020
---
> 阅读提示
> 适合对象：负责漏洞治理、扫描平台与风险优先级管理的安全运营同学。
> 阅读前提：了解 CVE、补丁和基本资产分类。
> 核心收获：把漏洞扫描结果转成可执行的评估、分级与修复流程。
> 说明：扫描器能力与插件库更新频繁，具体操作请结合当前版本界面与官方文档。
